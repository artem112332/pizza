...
class DeliveryInfo(models.Model):
    ...
    courier = models.ForeignKey('Worker', to_field='worker_id', related_name='Worker.courier+',
...
class Order(models.Model):
    ...
    chef = models.ForeignKey('Worker', to_field='worker_id', related_name='Worker.chef+', on_delete=models.SET_NULL,
